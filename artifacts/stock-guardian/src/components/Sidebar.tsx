...
export function Sidebar() {
  ...
  return (
    ...
    >
      {/* Logo */}
      <div className="px-6 py-6 border-b" style={{ borderColor: "hsl(220, 60%, 22%)" }}>
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs" style={{ color: "hsl(40, 54%, 54%)" }}>
      ...
      {/* User info */}
      {user && (
        <div className="px-4 py-4 border-b mx-2 mt-2 rounded-xl" style={{ backgroundColor: "hsl(220, 60%, 20%)", borderColor: "hsl(220, 60%, 24%)" }}>
          <div className="flex items-center gap-3">
            <div
